 ...
 * Interface for support categories
 */
...
// Numéro de téléphone du support / Support phone number
...
export default function SupportScreen() {
   ...
   * Opens the phone app to call support
   */
  const handleCall = () => {
   ...
   * Navigate to a specific support category
   */
