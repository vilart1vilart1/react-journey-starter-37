...
<div class="lv-item media">
    ...
    <div class="media-body">
        ...
        <ul class="lv-attrs">
            ...
            <li data-bind="visible: InvoiceDate">
                <span data-bind="translatedText: 'InvoiceDate'"></span>:
				<span data-bind="dateText: InvoiceDate"></span>
            </li>
            <li data-bind="visible: Commission">
                <span data-bind="translatedText: 'T_Reference'"></span>:
				<span data-bind="text: Commission"></span>
            </li>
            <li data-bind="visible: ExtensionValues().IsClosingInvoice">
                <span data-bind="translatedText: 'ClosingInvoice'"></span>
            </li>
        </ul>
    </div>
</div>
