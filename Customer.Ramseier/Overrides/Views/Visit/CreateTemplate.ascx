	...
	<div class="card">
		...
		<div class="card-body card-padding">
			<form role="form" data-bind="with: visit">
				<form-element id="ParentId" params="value: ParentId, caption: ''">
					<select name="ParentId" class="form-control" data-bind="select2autocompleter: { data: $parent.ParentId, autocompleteOptions: { table: 'Main_Company', orderBy: ['Name'], joins: Helper.Company.getAutocompleteJoins(), customFilter: Helper.Company.getSelect2Filter, mapDisplayObject: Helper.Company.mapDisplayNameWithAddressForSelect2, onSelect: $root.onSelectCompany } }" >
					</select>
				</form-element>
		...
		<% Html.RenderPartial("CreateFormFooter"); %>
	</div>
</div>