namespace("Customer.Ramseier.ViewModels").TurnoverListIndexViewModel = function () {
  ...
  viewModel.lookups = {
	...
	window.Main.ViewModels.GenericListViewModel.call(this, "CustomerRamseier_Turnover", ["ContactName"], ["ASC", "ASC"], ["Company"]);
...
namespace("Customer.Ramseier.ViewModels").TurnoverListIndexViewModel.prototype = Object.create(window.Main.ViewModels.GenericListViewModel.prototype);

namespace("Customer.Ramseier.ViewModels").TurnoverListIndexViewModel.prototype.init = function () {
	var viewModel = this;
...
namespace("Customer.Ramseier.ViewModels").TurnoverListIndexViewModel.prototype.applyFilters = function (query) {
	var viewModel = this;
	const operators = ['<', '>', '<=', '>=', '='];
