namespace Customer.Ramseier.Model.Configuration
{
    ...
    public class CustomQuoteConfiguration : QuoteConfigurationExtension,IReplaceRegistration<QuoteConfigurationExtension>
    {
        public CustomQuoteConfiguration(IEntityConfigurationHolder<Quote> entityConfigurationHolder, ILookupManager lookupManager)
