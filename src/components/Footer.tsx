  ...
  return (
    <>
      <footer className="bg-slate-800 text-white">
        {/* Newsletter Section */}
        <div className="bg-orange-500 py-4 md:py-6">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-2 max-w-sm mx-auto">
              <input
                ...
                className="flex-1 px-3 py-2 rounded text-slate-800 focus:outline-none focus:ring-2 focus:ring-white/50 text-sm"
              />
              <button className="bg-white text-orange-600 px-4 py-2 rounded font-semibold hover:bg-orange-50 transition-colors text-sm">
                S'abonner
              </button>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex space-x-3 items-center">
                  <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-orange-300 transition-colors">
                  ...
                  <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-orange-300 transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-orange-300 transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Navigation Links */}
              <div>
                <h3 className="text-lg font-semibold mb-3 text-orange-400">Informations</h3>
                <div className="space-y-2 text-sm">
                  <button 
                    onClick={() => setShowAboutModal(true)}
                    className="block text-slate-300 hover:text-orange-300 transition-colors text-left w-full"
                  >
                    À propos
                  </button>
                  <button 
              ...
              {/* Legal & Trust */}
              <div>
                <h3 className="text-lg font-semibold mb-3 text-orange-400">Sécurité</h3>
                <div className="space-y-2 text-sm mb-4">
                  <a href="#" className="block text-slate-300 hover:text-orange-300 transition-colors">Mentions légales</a>
                  <Link to="/refund-policy" className="block text-slate-300 hover:text-orange-300 transition-colors">
                    Politique de remboursement
                  </Link>
                  <Link to="/privacy-policy" className="block text-slate-300 hover:text-orange-300 transition-colors">
