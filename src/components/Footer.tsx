  ...
  return (
    <>
      <footer className="bg-slate-800 text-white font-baloo">
        {/* Newsletter Section */}
        <div className="bg-gradient-to-r from-light-coral to-powder-pink py-4 md:py-6">
          <div className="container mx-auto px-4 text-center">
            <h3 className="text-base md:text-lg font-bold text-white mb-2 font-baloo">
              Restez informé de nos nouveautés !
            </h3>
            <p className="text-white/90 mb-3 text-sm font-baloo">
            ...
            <div className="flex flex-col sm:flex-row gap-2 max-w-sm mx-auto">
              <input
                ...
                className="flex-1 px-3 py-2 rounded text-slate-800 focus:outline-none focus:ring-2 focus:ring-white/50 text-sm font-baloo"
              />
              <button className="bg-white text-light-coral px-4 py-2 rounded font-semibold hover:bg-cream-beige transition-colors text-sm font-baloo">
                S'abonner
              </button>
            </div>
          </div>
