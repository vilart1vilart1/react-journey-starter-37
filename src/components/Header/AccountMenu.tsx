    ...
    <Popover open={showAccountMenu} onOpenChange={setShowAccountMenu}>
      <PopoverTrigger asChild>
        <Button 
          variant="ghost" 
          size="sm"
          className="flex items-center space-x-1 sm:space-x-2 bg-white/90 backdrop-blur-sm hover:bg-white px-4 sm:px-6 py-3 rounded-xl shadow-lg transition-all duration-300 font-baloo font-medium"
        >
