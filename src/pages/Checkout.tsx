...
const Checkout = () => {
  ...
  useEffect(() => {
    ...
    // Fill user information for both authenticated subscription and single payment users
  ...
  if (selectedPlan === 'subscription' && !isAuthenticated && !showLoginModal && !showSignupModal) {
    return (
      <div 
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg max-w-md w-full mx-4 text-center border-2 border-orange-200">
          <div className="mb-6">
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              <span className="font-semibold text-orange-600"> créez votre compte famille</span> ou connectez-vous 
