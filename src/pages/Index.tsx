              ...
              <div className="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div className="lg:hidden w-full relative">
                  ...
                  zIndex: 1
                   ...
                   {/* Character images for mobile - left and right borders */}
                   <div className="absolute inset-0 pointer-events-none">
                     {/* Left character - wizard/witch - larger and higher position */}
                     <div className="absolute left-[20%] top-2/3 transform -translate-y-1/2 w-20 h-28 z-0">
                       <img src="/lovable-uploads/8029170b-89d6-404a-9375-bac7a7c4b672.png" alt="Character left" className="w-full h-full object-contain opacity-35" />
                     </div>
                     {/* Right character - superman - smaller and lower position */}
                     <div className="absolute right-[-40%] top-2/3 transform -translate-y-1/2 w-20 h-28 z-0">
                       <img src="/lovable-uploads/5e4ea06c-f640-41a9-9cce-ca518ea460c0.png" alt="Character right" className="w-full h-full object-contain opacity-50" />
                     </div>
                   </div>
                      ...
                      <div className="flex flex-col gap-0.5 pt-2 my-0 ml-[-3%]">
                        ...
                        <div ref={book5Animation.ref} className={`transform hover:scale-105 transition-all duration-500 hover:shadow-2xl ${book5Animation.isVisible ? 'animate-fade-in' : 'opacity-0'} hover:shadow-primary/30`}>
                          ...
                          filter: 'drop-shadow(0 15px 15px rgba(34, 197, 94, 0.5))'
                            ...
                            <img alt="The Magic Forest Adventure" className="w-full h-full object-contain rounded-lg" src="/lovable-uploads/e3eb0ac3-a28d-47b8-807d-3963b2ce38df.png" />
                          </div>
                        </div>
                        {/* Book 5 - Top right (middle start) */}
