...
import { ArrowLeft, Calendar, MapPin, Music, Info, Utensils, Phone, BookOpen } from 'lucide-react';
  ...
  const specialEvents: Event[] = [
    {
      ...
      description: "Une soirée exceptionnelle mettant en vedette deux artistes talentueux : Dorsaf Hamdani et Abdallah Mrich, dans un cadre élégant à l'Hôtel l'occidental.",
      price: 95,
      ...
      organizers: ["VILART Events", "La maison du traiteur"],
      about: "Dorsaf Hamdani est une chanteuse tunisienne renommée et maître du Tarab, Malouf ainsi que le répertorie Soufi. Avec sa voix exceptionnelle et sa maîtrise des répertoires classiques, elle a su conquérir un public international tout en préservant l'authenticité de la tradition musicale tunisienne et orientale. ",
      about2: "Abdallah Mrich est l'ambassadeur de Syrie en Tunisie, il se démarque par son aisance à interpréter les chefs-d'œuvres de Wadii Safi, les Qudud Halabeya et les grandes figures de la scène musicale syrienne et arabe, les icones disparues : Farid Al Atrach, Sabah Fakhri et Sabri Moudallal.",
